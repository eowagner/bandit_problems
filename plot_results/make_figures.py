...
diss_p_low.plot(kind="scatter", x="p1", y="success", color=colors[1], marker=markers[1], label="Low arm's dissemination restricted", ax=ax_diss)
diss_p_high.plot(kind="scatter", x="p1", y="success", color=colors[2], marker=markers[2], label="High arm's dissemination restricted", ax=ax_diss)
...
diss_agents_low.plot(kind="scatter", x="num_agents", y="success", color=colors[1], marker=markers[1], label="Low arm's dissemination restricted", ax=ax_diss_agents)
diss_agents_high.plot(kind="scatter", x="num_agents", y="success", color=colors[2], marker=markers[2], label="High arm's dissemination restricted", ax=ax_diss_agents)
...
ax_conduct_rand = conduct_rand.plot(kind="scatter", x="p1", y="1_res_success", color=circular_colors[0], label="1 restricted agent")
conduct_rand.plot(kind="scatter", x="p1", y="2_res_success", color=circular_colors[1], label="2 restricted agents", ax=ax_conduct_rand)
conduct_rand.plot(kind="scatter", x="p1", y="3_res_success", color=circular_colors[2], label="3 restricted agents", ax=ax_conduct_rand)
conduct_rand.plot(kind="scatter", x="p1", y="4_res_success", color=circular_colors[3], label="4 restricted agents", ax=ax_conduct_rand)
conduct_rand.plot(kind="scatter", x="p1", y="5_res_success", color=circular_colors[4], label="5 restricted agents", ax=ax_conduct_rand)
conduct_rand.plot(kind="scatter", x="p1", y="6_res_success", color=circular_colors[5], label="6 restricted agents", ax=ax_conduct_rand)
conduct_rand.plot(kind="scatter", x="p1", y="7_res_success", color=circular_colors[6], label="7 restricted agents", ax=ax_conduct_rand)
...
ax_conduct_comp = conduct_rand.plot(kind="scatter", x="p1", y="1_res_success", color=colors[0], marker=markers[0], label="1 restricted agent, random")
conduct_low.plot(kind="scatter", x="p0", y="1_res_success", color=colors[1], marker=markers[1], label="1 restricted agent, low", ax=ax_conduct_comp)
conduct_high.plot(kind="scatter", x="p1", y="1_res_success", color=colors[2], marker=markers[2], label="1 restricted agent, high", ax=ax_conduct_comp)
...
ax_hybrid_rand = hybrid_rand.plot(kind="scatter", x="p1", y="1_res_success", color=circular_colors[0], label="1 restricted agent")
hybrid_rand.plot(kind="scatter", x="p1", y="2_res_success", color=circular_colors[1], label="2 restricted agents", ax=ax_hybrid_rand)
hybrid_rand.plot(kind="scatter", x="p1", y="3_res_success", color=circular_colors[2], label="3 restricted agents", ax=ax_hybrid_rand)
hybrid_rand.plot(kind="scatter", x="p1", y="4_res_success", color=circular_colors[3], label="4 restricted agents", ax=ax_hybrid_rand)
hybrid_rand.plot(kind="scatter", x="p1", y="5_res_success", color=circular_colors[4], label="5 restricted agents", ax=ax_hybrid_rand)
hybrid_rand.plot(kind="scatter", x="p1", y="6_res_success", color=circular_colors[5], label="6 restricted agents", ax=ax_hybrid_rand)
hybrid_rand.plot(kind="scatter", x="p1", y="7_res_success", color=circular_colors[6], label="7 restricted agents", ax=ax_hybrid_rand)
...
ax_hybrid_comp = hybrid_rand.plot(kind="scatter", x="p1", y="1_res_success", color=colors[0], marker=markers[0], label="1 restricted agent, random")
hybrid_low.plot(kind="scatter", x="p0", y="1_res_success", color=colors[1], marker=markers[1], label="1 restricted agent, low", ax=ax_hybrid_comp)
hybrid_high.plot(kind="scatter", x="p1", y="1_res_success", color=colors[2], marker=markers[2], label="1 restricted agent, high", ax=ax_hybrid_comp)
...
ax_reg_comp = hybrid_rand.plot(kind="scatter", x="p1", y="1_res_success", color=colors[0], marker=markers[0], label="Both conduct and dissemination restricted")
diss_p_rand.plot(kind="scatter", x="p1", y="success", label="Only dissemination restricted", color=colors[1], marker=markers[1], ax=ax_reg_comp)
conduct_rand.plot(kind="scatter", x="p1", y="1_res_success", label="Only conduct restricted", color=colors[2], marker=markers[2], ax=ax_reg_comp)
