...
p_star = normalize(pd.read_csv(dirnameOG+'diss-p-randomized.csv', comment='#'), 'success')
...
plt.savefig("figures/randr_alt_graphs_p.pdf")

agents_star = normalize(pd.read_csv(dirnameOG+'diss-agents-6-randomized.csv', comment='#'), 'success')
agents_wheel = normalize(pd.read_csv(dirname+'wheel-agents.csv', comment='#'), 'success')
agents_cycle_1 = normalize(pd.read_csv(dirname+'cycle-1-agents.csv', comment='#'), 'success')
agents_cycle_2 = normalize(pd.read_csv(dirname+'cycle-2-agents.csv', comment='#'), 'success')
agents_cycle_3 = normalize(pd.read_csv(dirname+'cycle-3-agents.csv', comment='#'), 'success')
agents_base = normalize(pd.read_csv(dirnameOG+'baseline-agents-6.csv', comment='#'), 'success_complete')
...
ax.set_ylabel("Probability of successful learning")
ax.set_title("Alternative dissemination networks")
plt.savefig("figures/randr_alt_graphs_agents.pdf")